    ...
    await signInWithEmailAndPassword(getAuth(getApp()), newEmail, newPass)
      ...
      .catch((error) => {
        ...
        if (
          ...
          response = {
            error:
              "Hoppá! Túl sokszor próbáltál bejelentkezni, próbálkozz később!",
          };
        else response = { error: "error: " + errorCode + " - " + errorMessage };
      });
      ...
      .catch(async (error: FirebaseError) => {
        ...
        if (error.code === "auth/account-exists-with-different-credential") {
          ...
          if (error.customData?.email) {
            FacebookAuthProvider.credentialFromError(error) as AuthCredential;
